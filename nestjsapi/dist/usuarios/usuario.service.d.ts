...
export declare class UsuarioService {
    ...
    constructor(agendamentoModel: Model<IAgendamento>, clientsModel: Model<ICliente>, usuarioModel: Model<IUsuario>);
    criarUsuario(data: CreateUsuarioDto): Promise<void>;
    getUsuarios(): Promise<(import("mongoose").Document<unknown, {}, IUsuario> & IUsuario & {
